...
require_once dirname(__FILE__).'/../vendor/Mailchimp/Folders.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Templates.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Users.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Helper.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Mobile.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Ecomm.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Neapolitan.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Lists.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Campaigns.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Vip.php';
require_once dirname(__FILE__).'/../vendor/Mailchimp/Reports.php';
